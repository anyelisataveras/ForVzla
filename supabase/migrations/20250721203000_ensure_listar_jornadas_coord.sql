-- Ensure listar_jornadas_coord exists (missing in some prod envs → panel shows "Sin sitio")
-- security definer so sitio nombre/zona no depend on PostgREST embed + RLS on sitios
